        ...
        @if($showControls)
            <x-tall-interactive::forms.controls.base>
                <x-dynamic-component :component="'tall-interactive::forms.controls.' . $controlsDesign">
                    ...
                    <button wire:click="{{ $formClass ? 'submit': 'submitSlot' }}" type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary-600 text-base font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2
